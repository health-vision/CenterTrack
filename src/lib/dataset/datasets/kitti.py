...
class KITTI(GenericDataset):
    ...
    def save_results(self, results, save_dir):
        ...
        for img_id in results.keys():
            ...
            for i in range(len(results[img_id])):
                ...
                f.write(" {:.2f} {:.2f} {:.2f}".format(item["dim"][0], item["dim"][1], item["dim"][2]))
                f.write(" {:.2f} {:.2f} {:.2f}".format(item["loc"][0], item["loc"][1], item["loc"][2]))
    ...
    def run_eval(self, results, save_dir):
        ...
        os.system(
            "./tools/kitti_eval/evaluate_object_3d_offline_07 "
