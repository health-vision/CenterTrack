...
VIDEO_SETS = {"train": range(21), "test": range(29), "train_half": range(21), "val_half": range(21)}
...
cats = ["Pedestrian", "Car", "Cyclist", "Van", "Truck", "Person_sitting", "Tram", "Misc", "DontCare"]
...
if __name__ == "__main__":
    for split in SPLITS:
        ...
        for i in VIDEO_SETS[split]:
            ...
            video_path = DATA_PATH + "/data_tracking_image_2/{}ing/image_02/{}".format(ann_dir, video_name)
            calib_path = DATA_PATH + "data_tracking_calib/{}ing/calib/".format(ann_dir) + "{}.txt".format(video_name)
            ...
            for ann_ind, txt in enumerate(anns):
                ...
                amodel_center = project_to_image(
                    np.array([location[0], location[1] - dim[0] / 2, location[2]], np.float32).reshape(1, 3), calib
                )[0].tolist()
                ann = {
