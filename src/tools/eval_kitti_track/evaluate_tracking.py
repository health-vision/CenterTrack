...
class trackingEvaluation(object):
    ...
    def __init__(
        ...
        filename_test_mapping = "./tools/eval_kitti_track/data/tracking/" + "evaluate_tracking{}.seqmap".format(
            split_version
        )
        self.n_frames = []
        self.sequence_name = []
        ...
        self.n_igttr = (
            0
        )  # number of ignored ground truth detections where the corresponding associated tracker detection is also ignored
